...
export const REFRESH_TOKEN_PRE_TIME =15 //s;

// location address

export const BASE_ADDRESSS = "https://raw.githubusercontent.com/nhidh99/codergamo/master/004-location-selects/locations"
export const PATHS = {
  CITIES:
